...
public final class Animation {
  ...
  @JRDoc_PT("Retorna o quadro da animação do índece especificado.")
  @UnimplementedDoc
  @MethodArgs({"index"})
  ...
  @JRDoc_PT("Define o quadro do índece para o AnimationFrame especificado.")
  @UnimplementedDoc
  ...
  @JRDoc_EN("Sorts animation frames.")
  @JRDoc_PT("Reorganiza os frames da animação.")
  @UnimplementedDoc
