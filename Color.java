...
public final class Color implements SumOperator, SubOperator, MulOperator, DivOperator, SumEqualOperator, SubEqualOperator, MulEqualOperator, DivEqualOperator, EqualsComparator, GreaterThanComparator, LessThanComparator, JsonSerializer {
  ...
  /** Integer color Also called by HEX */
  ...
  @JRDoc_PT("Define a Cor para a Cor do código hexadecinal especificado.")
  @MethodArgs({"hex"})
  ...
  @JRDoc_EN("Returns the hexadecinal code of the Color.")
  @JRDoc_PT("Retorna o código hexadecinal da Cor.")
  ...
  @JRDoc_PT("Retorna verdadeiro se a instância da Cor especificada é igual a instância da Cor atual.")
  @MethodArgs({"otherObject"})
  ...
  @JRDoc_PT("Retorna verdadeiro se a Cor especificada for nulo.")
  @MethodArgs({"value"})
  ...
  @JRDoc_EN("Deserializes a string in the format '[R;G;B;A]' and applies the values to this color.")
  @JRDoc_PT("Desserializa uma string no formato '[R;G;B;A]' e aplica os valores a esta cor.")
