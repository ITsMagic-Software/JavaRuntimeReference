...
public final class Device {
  ...
  /**
   * * @param timings The pattern of alternating on-off timings, starting with an 'off' timing, and representing the length of time to sustain the individual item (not cumulative).
   *
   * @param repeat The index into the timings array at which to repeat, or -1 if you don't want to repeat indefinitely.
   */
