...
//>REMOVE-BRIDGE<
{
    //<REMOVE-BRIDGE>
    @IgnoreAutoComplete
    private static String FILE_FORMAT = FormatDictionaries.FRAGMENT_GLSL;

    @IgnoreAutoComplete
    public static ClassInspectorEntry inspectorController(){
        Class thisClass = FragmentGLSLFile.class;
        return new ClassInspectorEntry(new ClassInterface() {
            ...
            public Variable save(String fieldName, Object value, UserPointer userPointer) {
                FragmentGLSLFile file = (FragmentGLSLFile) value;
                if(file != null) {
            ...
            public Object restore(Variable variable, UserPointer userPointer) {
                if(variable.type == Variable.Type.File){
                    return new FragmentGLSLFile(variable.str_value);
                }
                return null;
            }
    ...
    public FragmentGLSLFile(String path) {
        super(path);
    }
    //>REMOVE-BRIDGE<
