...
public final class Laser {
  ...
  @MethodArgs({"ray"})
  public List<LaserHit> traceAll(JAVARuntime.Ray ray) {
  ...
  @MethodArgs({"position", "direction"})
  public List<LaserHit> traceAll(Vector3 position, Vector3 direction) {
  ...
  @MethodArgs({"position", "direction", "distance"})
  public List<LaserHit> traceAll(Vector3 position, Vector3 direction, float distance) {
  ...
  @MethodArgs({"position", "direction", "distance", "layer"})
  public List<LaserHit> traceAll(Vector3 position, Vector3 direction, float distance, PhysicsLayer layer) {
  ...
  @MethodArgs({"position", "direction", "layer"})
  public List<LaserHit> traceAll(Vector3 position, Vector3 direction, PhysicsLayer layer) {
  ...
  @MethodArgs({"ray"})
  public LaserHit traceSphere(JAVARuntime.Ray ray, float radius) {
  ...
  @MethodArgs({"position", "direction"})
  public LaserHit traceSphere(Vector3 position, Vector3 direction, float radius) {
  ...
  @MethodArgs({"position", "direction", "distance"})
  public LaserHit traceSphere(Vector3 position, Vector3 direction, float distance, float radius) {
  ...
  @MethodArgs({"position", "direction", "distance", "layer"})
  public LaserHit traceSphere(Vector3 position, Vector3 direction, float distance, PhysicsLayer layer, float radius) {
  ...
  @MethodArgs({"position", "direction", "layer"})
  public LaserHit traceSphere(Vector3 position, Vector3 direction, PhysicsLayer layer, float radius) {
  ...
  @MethodArgs({"ray"})
  public List<LaserHit> traceSphereAll(JAVARuntime.Ray ray, float radius) {
  ...
  @MethodArgs({"position", "direction"})
  public List<LaserHit> traceSphereAll(Vector3 position, Vector3 direction, float radius) {
  ...
  @MethodArgs({"position", "direction", "distance"})
  public List<LaserHit> traceSphereAll(Vector3 position, Vector3 direction, float distance, float radius) {
  ...
  @MethodArgs({"position", "direction", "distance", "layer"})
  public List<LaserHit> traceSphereAll(Vector3 position, Vector3 direction, float distance, PhysicsLayer layer, float radius) {
  ...
  @MethodArgs({"position", "direction", "layer"})
  public List<LaserHit> traceSphereAll(Vector3 position, Vector3 direction, PhysicsLayer layer, float radius) {
