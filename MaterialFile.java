...
//>REMOVE-BRIDGE<
{
    //<REMOVE-BRIDGE>
    @IgnoreAutoComplete
    private static String FILE_FORMAT = ".mat";

    @IgnoreAutoComplete
    public static ClassInspectorEntry inspectorController(){
        Class thisClass = MaterialFile.class;
        return new ClassInspectorEntry(new ClassInterface() {
            ...
            public Variable save(String fieldName, Object value, UserPointer userPointer) {
                MaterialFile file = (MaterialFile) value;
                if(file != null) {
            ...
            public Object restore(Variable variable, UserPointer userPointer) {
                if(variable.type == Variable.Type.File){
                    return new MaterialFile(variable.str_value);
                }
                return null;
            }
    ...
    @IgnoreAutoComplete
    public MaterialFile(String path) {
        super(path);
    }
    //>REMOVE-BRIDGE<
