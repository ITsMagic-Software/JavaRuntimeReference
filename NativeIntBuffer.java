...
public class NativeIntBuffer {
    //<REMOVE-BRIDGE>
    @IgnoreAutoComplete
    public transient com.itsmagic.engine.Engines.Native.Base.NativeIntBuffer buffer;
    @IgnoreAutoComplete
    public NativeIntBuffer(com.itsmagic.engine.Engines.Native.Base.NativeIntBuffer buffer) {
        this.buffer = buffer;
        this.buffer.setRuntime(this);
    }

    @BuildClassConstructor
    public NativeIntBuffer(Engine engine) { }
    //>REMOVE-BRIDGE<

    @MethodArgs(args ={"capacity"})
    public NativeIntBuffer(int capacity) {
        //<REMOVE-BRIDGE>
        this.buffer = new com.itsmagic.engine.Engines.Native.Base.NativeIntBuffer(capacity);
        //>REMOVE-BRIDGE<
    }
