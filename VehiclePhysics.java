...
public class VehiclePhysics extends Component {
 ...
 @JRDoc_EN("Sets the torque for the specified wheel.")
    @JRDoc_PT("Define o torque para a roda especificada.")
    @MethodArgs({"torque","wheelID"})
    public void setTorque(float torque, int wheelID){
        //
    }

    @JRDoc_EN("Sets the brake force for the specified wheel.")
    @JRDoc_PT("Define a força de frenagem para a roda especificada.")
    @MethodArgs({"brake","wheelID"})
    public void setBrake(float brake, int wheelID){
        //
    }

    @JRDoc_EN("Sets the steering angle for the specified wheel (in degrees).")
    @JRDoc_PT("Define o ângulo da roda especificada (em graus).")
    @MethodArgs({"steer","wheelID"})
    public void setSteer(float steer, int wheelID){
        //
    }

    @JRDoc_EN("Sets the steering angle for the specified wheel (in degrees), adjusting based on the vehicle's speed. Helps prevent the vehicle from flipping over.")
    @JRDoc_PT("Define o ângulo da roda especificada (em graus), ajustando com base na velocidade do veículo. Ajuda a evitar que o veículo capote.")
    @MethodArgs({"steer","wheelID"})
    public void setSteerRelativeVelocity(float steer, int wheelID){
        //
    }
    @JRDoc_EN("Sets the maximum steering angle for the vehicle (in degrees). Used in the setSteerRelativeVelocity method as the maximum possible angle.")
    @JRDoc_PT("Define o ângulo máximo de direção para o veículo (em graus). Usado no método setSteerRelativeVelocity como ângulo máximo possível.")
    @MethodArgs({"maxSteer"})
    public void setMaxSteerAngle(float maxSteer){
        //
    }
    @JRDoc_EN("Sets the minimum steering angle for the vehicle (in degrees). Used in the setSteerRelativeVelocity method as the minimum possible angle.")
    @JRDoc_PT("Define o ângulo mínimo de direção para o veículo (em graus). Usado no método setSteerRelativeVelocity como ângulo mínimo possível.")
    @MethodArgs({"steer"})
    public void setMinSteerAngle(float steer){
        //
    }
    @JRDoc_EN("Sets the maximum speed the vehicle can reach (in KM/H). Used in the setSteerRelativeVelocity method as the maximum possible speed.")
    @JRDoc_PT("Define a velocidade máxima que o veículo pode atingir (em KM/H). Usado no método setSteerRelativeVelocity como velocidade máxima possível.")
    @MethodArgs({"speed"})
    public void setSteerMaxSpeed(float speed){
        //
    }

    @JRDoc_EN("Returns the speed of the vehicle in KM/H.")
    @JRDoc_PT("Retorna a velocidade do veículo em KM/H.")
    @HideGetSet
    ...
    @JRDoc_EN("Returns the suspension length of the vehicle.")
    @JRDoc_PT("Retorna o comprimento da suspensão do veículo.")
    @HideGetSet
    ...
    @JRDoc_EN("Sets the suspension length for the vehicle.")
    @JRDoc_PT("Define o comprimento da suspensão para o veículo.")
    @HideGetSet
    @MethodArgs({"value"})
    ...
    @JRDoc_EN("Returns the suspension stiffness of the vehicle.")
    @JRDoc_PT("Retorna a rigidez da suspensão do veículo.")
    @HideGetSet
    ...
    @JRDoc_EN("Sets the suspension stiffness for the vehicle.")
    @JRDoc_PT("Define a rigidez da suspensão para o veículo.")
    @HideGetSet
    @MethodArgs({"value"})
    ...
    @JRDoc_EN("Returns a list of all wheels on the vehicle.")
    @JRDoc_PT("Retorna uma lista de todas as rodas do veículo.")
