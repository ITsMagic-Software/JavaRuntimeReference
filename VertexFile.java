...
//>REMOVE-BRIDGE<
{
    //<REMOVE-BRIDGE>
    @IgnoreAutoComplete
    private static String FILE_FORMAT = FormatDictionaries.VERTEX + "|" + FormatDictionaries.OBJ;

    @IgnoreAutoComplete
    public static ClassInspectorEntry inspectorController(){
        Class thisClass = VertexFile.class;
        return new ClassInspectorEntry(new ClassInterface() {
            ...
            public Variable save(String fieldName, Object value, UserPointer userPointer) {
                VertexFile file = (VertexFile) value;
                if(file != null) {
